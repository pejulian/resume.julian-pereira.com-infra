...
} from "../lib/resume.julian-pereira.com-infra-stack";
...
const githubTokenSsmParameterName = tryGetContext<string, true>(
  app,
...
const stack = new ResumeJulianPereiraComInfraStack(
  app,
  "ResumeJulianPereiraComInfraStack",
  {
    owner,
